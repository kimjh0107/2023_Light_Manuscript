...
data <- read_csv(here("data/raw/figure3/random_sampling_auc_diagnosis_timepoint1_CD8_healthy_timepoint1_CD8.csv"))
...
ggsave(here("figure/figure3C.pdf"), fig, width = 90, height = 60, units = 'mm')
